    ...
    <div className="home">
      ...
      {(param === undefined || param === 'tv') && (
        <>
          ...
          <Row title="Popular on Netflix" fetchUrl={requests.fetchTopRatedTV} />
          <Row
            title="Netflix Originals"
            fetchUrl={requests.fetchNetflixOriginalsTV}
          />
          <Row title="New Releases" fetchUrl={requests.fetchTrendingTV} />
        </>
      )}
      ...
      {param === 'latest' && (
        <>
          <Row
            ...
            fetchUrl={requests.fetchTrendingMovie}
          />
          <Row title="New on Netflix" fetchUrl={requests.fetchTrendingTV} />
          <Row
